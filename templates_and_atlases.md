...
Below, we provide a non-exhaustive list of existing templates and atlases. For a more detailed resource list of templates and atlasses see [this list](templates_and_atlasses2.md).
...
For a more detailed resource list of templates and atlasses see [this list](templates_and_atlasses2.md).
